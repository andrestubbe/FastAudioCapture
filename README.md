# FastAudioCapture 0.1.1 [ALPHA-2026-08] — High-Performance Native Audio Engine for Java
...
```java
import fastaudiocapture.*;

public class Demo {
    public static void main(String[] args) {
        System.out.println("FastAudioCapture 0.1.1 initialized.");
    }
}
```
