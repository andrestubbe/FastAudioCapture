# FastAudioCapture Roadmap 🗺️

**Vision:** To provide the fastest possible native primitives for audio capture by aggressively bypassing bottlenecks in standard Java.
